...
// public void setUp() {
// createTestUserData();
// user = new User("Alice", "Smith", "alice@example.com", "pw123", 2,
// staticUserId);
// }

// /**
// * Cleans up after each test by removing all sessions associated with the
// user.
// */
// @After
...
// GameSession gs = new GameSession(user.getUUID(), "TeamA", "SessionA",
// "Horror", 1, 1);
// UUID actualSessionId = gs.getSessionID();

// user.storeGameSession(gs);

// assertSame("Stored session should be retrievable by its ID", gs,
// user.getSession(actualSessionId));

// ArrayList<GameSession> sessions = user.getAllSessions();
// assertEquals("Should have one stored session", 1, sessions.size());
// assertSame("The stored session should be the same instance", gs,
// sessions.get(0));
// }
...
// GameSession gs = new GameSession(user.getUUID(), "TeamB", "SessionB",
// "Fantasy", 2, 2);
...
// assertEquals("Stringified id should match session id", id.toString(),
// ids.get(0));
// }
...
// GameSession gs1 = new GameSession(user.getUUID(), "TeamOne",
// "TeamOneSession", "Mystery", 1, 1);
// GameSession gs2 = new GameSession(user.getUUID(), "TeamTwo", "OtherSession",
// "SciFi", 2, 2);
...
// assertNull("Nonexistent session should return null",
// user.chooseSession("noSuchSession"));
// }
...
// GameSession gs = new GameSession(user.getUUID(), "TeamC", "SessionC",
// "Historical", 3, 4);
// UUID id = gs.getSessionID();
...
// assertTrue("getAllSessions should be empty after removal",
// user.getAllSessions().isEmpty());
// }

// /**
// * Tests that storing a null GameSession does nothing and causes no
// exceptions.
// */
// @Test
// public void testStoreNullSession_doesNothing() {
// user.storeGameSession(null);
// assertTrue("No sessions should exist after storing null",
// user.getAllSessions().isEmpty());
// }
...
// assertTrue("toString should contain first name", s.contains("First Name:
// Alice"));
// assertTrue("toString should contain last name", s.contains("Last Name:
// Smith"));
// assertTrue("toString should contain email", s.contains("Email:
// alice@example.com"));
// assertTrue("toString should contain avatar selection", s.contains("Avatar
// Selection No.:2"));
// }
// }
