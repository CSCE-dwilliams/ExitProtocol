...
public class User {
    ...
    // Should instead be theme hmm idk idk idk
    ...
    public GameSession createAndAddSession(String teamName, String theme, int difficulty,
            int playerCount) {
        GameSession s = new GameSession(this.id, teamName, theme, difficulty, playerCount);
        storeGameSession(s);
     ...
     */
    public GameSession getSession(String theme) {
        return sessions.get(theme);
    }
