 ...
 * ranked by total scores. It interacts with {@link UserList},
 * {@code DataLoader}, and {@link DataWriter} to
 * load, update, and persist user data. The scores are computed based on the
 * {@code GameSession} scores
...
public class Leaderboard {
     ...
     * 
     * For existing users the {@code UserList} are cleared and replaced with the
     * latest
     ...
     * @return the total score across all game sessions and returns 0 if the user
     *         has no sessions
     */
     ...
     * order. The total score for each user is calculated through the
     * {@link calculateTotalScore} method.
    ...
    public static void main(String[] args) {
         ...
         * User newPlayer = new User("Jada", "Young", "Jada@email.com", "12345", 0,
         * UUID.randomUUID());
